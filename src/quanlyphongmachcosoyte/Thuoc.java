...
public class Thuoc extends DichVuYTe {
    ...
    public String taoChuoiCSV() {
        // Định dạng: LoaiDV, MaDV, TenDV, GiaTien, XepLoai, DonViTinh, HeSoThuoc
        // LoaiDV: "Thuoc"
        // Các thuộc tính kế thừa (maDV, tenDV, giaTien, xeploai) là protected/accessible
        return "Thuoc," + maDV + "," + tenDV + "," + giaTien + "," + xeploai + "," + donViTinh + "," + hesoThuoc;
    }
}